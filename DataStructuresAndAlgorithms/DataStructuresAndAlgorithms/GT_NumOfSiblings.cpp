...
int GT_NumOfSiblings(GenericTreeNode * root)
{
	int num = 0;
...
void GT_NumOfSiblings_main()
{
	...
	*/
	...
	cout << "No. of the Children of the node " << root->getdata() << " in the Generic Tree = " << GT_NumOfSiblings(root) << "\n";
	cout << "No. of the Children of the node " << node2->getdata() << " in the Generic Tree = " << GT_NumOfSiblings(node2) << "\n";
	cout << "No. of the Children of the node " << node4->getdata() << " in the Generic Tree = " << GT_NumOfSiblings(node4) << "\n";
	cout << "No. of the Children of the node " << node8->getdata() << " in the Generic Tree = " << GT_NumOfSiblings(node8) << "\n";
